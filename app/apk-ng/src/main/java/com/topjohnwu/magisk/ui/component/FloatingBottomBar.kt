...
// Ported from KernelSU (tiann/KernelSU) miuix theme.
// 在 Original 主题（纯 Material3）下提供悬浮底栏 + 液态玻璃，
// 不依赖完整 miuix-ui，仅依赖 miuix-blur 的 Backdrop/drawBackdrop/lens 等 API。
...
import com.topjohnwu.magisk.ui.component.liquid.InnerShadow
import com.topjohnwu.magisk.ui.component.liquid.innerShadow
import com.topjohnwu.magisk.ui.component.liquid.lens
import com.topjohnwu.magisk.ui.component.liquid.rememberCombinedBackdrop
import com.topjohnwu.magisk.ui.component.liquid.vibrancy
import com.topjohnwu.magisk.ui.component.miuix.animation.DampedDragAnimation
import com.topjohnwu.magisk.ui.component.miuix.animation.InteractiveHighlight
...
fun FloatingBottomBar(
    ...
    // 用 Material3 ColorScheme 替换原 MiuixTheme.colorScheme（保持 Original 主题不变）
